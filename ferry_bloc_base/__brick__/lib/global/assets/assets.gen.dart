...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/ferry_logo.svg
  SvgGenImage get ferryLogo =>
      const SvgGenImage('assets/images/ferry_logo.svg');

  /// List of all assets
  List<dynamic> get values => [blocLogo, ferryLogo];
}
